 ...
 * Interface Pardiso linear system solver (U. Basel version).
 * @author Pedro Maciel
 */
  ...
  public cf3::common::Library
{
  ...
  static std::string library_description()  { return "Interface Pardiso linear system solver (U. Basel version)."; }
